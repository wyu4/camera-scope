...
public class Robot extends LoggedRobot {
  private PlayVideoCmd playVideoCmd;
   ...
   */
  public Robot() {
    Logger.recordMetadata("ProjectName", "camera-scope");
  ...
  public void autonomousInit() {
    ...
    playVideoCmd = new PlayVideoCmd(videoPlayer);
    playVideoCmd.schedule();
  }
